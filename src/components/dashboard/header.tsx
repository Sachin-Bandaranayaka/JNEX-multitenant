...
export function Header({ tenant, userName }: { tenant: Tenant; userName?: string | null }) {
    return (
        <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border/40 bg-background/80 px-6 backdrop-blur-xl transition-all">
